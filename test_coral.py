...
def main():
    ...
    config = Config(args, embedding, 'CORAL')
    ...
    model = CORAL(config).cuda()
    init_model(model)
    print("start training...")
    train_coral(config, model, train_iter, test_iter, imp)
